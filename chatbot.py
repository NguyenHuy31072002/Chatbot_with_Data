...
def create_qa_chain(prompt, db):
    ...
    class CustomRetrievalQA:
        ...
        def invoke(self, inputs):
            query = inputs["query"]
            docs = self.retriever.get_relevant_documents(query) #Dòng này gọi phương thức get_relevant_documents của đối tượng retriever để tìm kiếm các tài liệu liên quan trong cơ sở dữ liệu (db) dựa trên query. Các tài liệu trả về sẽ được lưu trong biến docs.
